...
from lgsdf.modules import sample
from lgsdf.eval import metrics
from lgsdf.datasets import dataset, image_transforms
from lgsdf.datasets import sdf_util
from lgsdf.geometry import transform
...
def fixed_pts_eval(
    ...
    t_str = f"{t:.3f}"
    # 获取该评估时刻的voxblox的数据，如“/media/dyn/DYN1/Research/dataset/iSDF/eval_pts/vox/0.055/apt_3_obj/eval_pts/2.451”
